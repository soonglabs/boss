...
var JSON_IMAGE = {
   ...
   "dirs":{
      ...
      "etc":{
         ...
         "files":{
            "supervisor":{
               "created":1468210455324,
               "data":"(function(){\n    boss.cmd.supervisor(['supervisor','load','test'], new ConsoleClient(boss));\n})"
            },
            "mount":{
               "created":1468211412457,
               "data":"(function(){\n    boss.cmd.mount(['mount', 'test'], new ConsoleClient(boss));\n})"
            }
         }
      },
      "home":{
