      ...
      "etc":{
         ...
         "files":{
            "supervisor":{
               ...
               "data":"(function(){\n    boss.cmd.supervisor(['supervisor','load','develop'], new ConsoleClient(boss));\n})"
            },
            "mount":{
               "created":1468211412457,
               "data":"(function(){\n    boss.cmd.mount(['mount', 'develop'], new ConsoleClient(boss));\n})"
            }
         }
      },
      "home":{
